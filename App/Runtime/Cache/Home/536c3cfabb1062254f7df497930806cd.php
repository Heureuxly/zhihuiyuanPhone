...
<head>
    ...
    <link rel="stylesheet" href="/zhihuiyuan(1)/Public/Home/css/regm.css">
    <link rel="stylesheet" href="/zhihuiyuan(1)/Public/Home/css/font-awesome.css">

    <script src="/zhihuiyuan(1)/Public/Home/js/jquery.js"></script>
...
<div id="content" class="main">
	<div class="reg_form">
		...
		<form action="/zhihuiyuan(1)/Login/zhuce" onsubmit="return checksubmit('reg')" method="post" enctype="multipart/form-data">
            <ul>
                <li>
                    <label id="head_P">
                ...
                <li>
                    <span class="dvstar"><img src="/zhihuiyuan(1)/Public/Home/img/login_star.png" alt=""></span>    
                    <select name="sex" id="">
