...
<head>
    ...
    <link rel="stylesheet" href="/zhihuiyuan/zhihuiyuanPhone/Public/Home/css/regm.css">
    <link rel="stylesheet" href="/zhihuiyuan/zhihuiyuanPhone/Public/Home/css/font-awesome.css">

    <script src="/zhihuiyuan/zhihuiyuanPhone/Public/Home/js/jquery.js"></script>
    ...
    <script src="/zhihuiyuan/zhihuiyuanPhone/Public/Home/js/reg.js"></script>
...
<div id="content" class="main">
	<div class="reg_form">
		...
		<form action="/zhihuiyuan/zhihuiyuanPhone/Login/zhuce" onsubmit="return checksubmit('reg')" method="post" enctype="multipart/form-data">
            <ul>
                <li>
                    <label id="head_P">
                 ...
                 <li>
                   <input style="margin-top: .8125rem;" class="text" type="text" name="user" value="姓名：请输入真实姓名"> 
                   <span class="info info_user"></span>
                   <span class="error error_user" style="margin-left:-132px;top:3.65rem;">姓名不能出现数字、英文、标点符号、特殊字符！</span>
                </li>
                <li>
                    <span class="dvstar"><img src="/zhihuiyuan/zhihuiyuanPhone/Public/Home/img/login_star.png" alt=""></span>    
                    <select name="sex" id="">
